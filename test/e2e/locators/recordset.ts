...
export default class RecordsetLocators {
  ...
  static getActionsHeader(container: Page | Locator): Locator {
    return container.locator('.actions-header').filter({ hasNot: container.locator('.sticky-header-table') });
  }
  ...
  static getColumnNames(container: Page | Locator): Locator {
    return container.locator('.table-column-displayname > span').filter({ hasNot: container.locator('.sticky-header-table') });
  };
