          ...
          await test.step('display the "Automatically generated" placeholder', async () => {
            switch (col.type) {
              ...
              case RecordeditInputType.BOOLEAN:
                await expect
                  .soft(RecordeditLocators.getInputPlaceholderMessage(page, col.name, 1))
                  .toHaveText('Automatically generated');
                break;
              default:
                await testAutomaticallyGenerated(
                  RecordeditLocators.getInputForAColumn(page, col.name, 1),
                  col.displayname
                );
                break;
            }
