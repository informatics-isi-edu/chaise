...
var testParams = {
    ...
    columns: [
        ...
        { name: "cover", isForeignKey: true, title: "Cover Image", value: "3005", type: "int2", presentation: { type: "url", template: "{{{chaise_url}}}/record/#{{catalog_id}}/product-delete:file/id=3005"} },
