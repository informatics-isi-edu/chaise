function loadModule() {
    (function () {
        ...
        .config(['$cookiesProvider', '$logProvider', '$provide', '$uibTooltipProvider', 'ConfigUtilsProvider', function ($cookiesProvider, $logProvider, $provide, $uibTooltipProvider, ConfigUtilsProvider) {
