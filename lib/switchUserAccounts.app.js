...
/* md help App */
    ...
    .controller('SwitchUserAccountsController', ['headInjector', 'logService', 'Session', '$scope', function (headInjector, logService, Session, $scope) {
        $scope.login = function () {
            Session.loginInAPopUp(logService.logActions.SWITCH_USER_ACCOUNTS_WIKI_LOGIN);
        }

        $scope.logout = function () {
            Session.logout(logService.logActions.SWITCH_USER_ACCOUNTS_LOGOUT);
        }
    }]);
})();
