function loadModule() {
    (function () {
        ...
        .config(['ConfigUtilsProvider', '$cookiesProvider', '$logProvider', '$provide', '$uibTooltipProvider', function (ConfigUtilsProvider, $cookiesProvider, $logProvider, $provide, $uibTooltipProvider) {
