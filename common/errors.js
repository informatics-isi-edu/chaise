        ...
        + '<div class="modal-dialog ">'
            + '<div class="modal-content" uib-modal-transclude="">'
                ...
                + '<div class="modal-body ">'
                    ...
                    + '<br><br>'
                    + 'Click OK to return to the Home Page. <a onclick="document.querySelector(\'.terminalError\').classList.toggle(\'hide\');">Hide Details</a>'
                    + '<br>'
                    + '<span class="terminalError hide"><br>'
