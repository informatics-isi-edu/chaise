...
.PHONY: test
test:
	$(BIN)/protractor $(E2EDrecord2) && $(BIN)/protractor $(E2EDIsearch) && $(BIN)/protractor $(E2Enavbar) && $(BIN)/protractor $(E2EDsearch) && $(BIN)/protractor $(E2EDIrecordAdd) && $(BIN)/protractor $(E2EDIrecordEdit) && $(BIN)/protractor $(E2Elogin)
