...
| recordset                          | confirm delete cancelled   | cli/delete/cancel           | RID     | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | delete clicked             | cli/delete/intend           |         | Delete was clicked from submenu bar and confirm delete was shown. (use cid to determine app)                                   |                               |
| record                             | confirm delete cancelled   | cli/delete/cancel           |         | User closed the confirm delete modal without deleting                                                                          |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordset                          | export dropdown            | cli/export                  |         | Dropdown was opened. Selecting an export option will send a request, no need to capture that event (use cid to determine app)  |                               |
| recordset                          | copy permalink             | cli/permalink/lclick        |         | User left clicked on permalink button (copies link to clipboard)                                                               |                               |
| recordset                          | permalink                  | cli/permalink/rclick        |         | User right clicked on permalink button and opened the context menu (we can't track which action was clicked)                   |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | show empty sections        | cli/show-empty/show         |         | "Show empty sections" button clicked in submenu bar                                                                            |                               |
| record                             | hide empty sections        | cli/show-empty/hide         |         | "Hide empty sections" button clicked in submenu bar                                                                            |                               |
| record                             | export dropdown            | cli/export                  |         | Dropdown was opened. Selecting an export option will send a request, no need to capture that event (use cid to determine app)  |                               |
| record                             | share popup                | cli/share                   |         | Share dialog was opened                                                                                                        |                               |
| record                             | copy live link             | cli/share/live              |         | Live link was copied to clipboard using glyphicon button                                                                       |                               |
| record                             | copy version link          | cli/share/version           |         | Versioned link was copied to clipboard using glyphicon button                                                                  |                               |
| record                             | Scroll top clicked         | cli/scroll-top              |         | Bottom right, "Scroll to top" button clicked                                                                                   |                               |
| record                             | ToC panel open             | cli/toc/show                |         | "Show side panel" button clicked                                                                                               |                               |
| record                             | ToC panel collapse         | cli/toc/hide                |         | "Hide panel" button clicked                                                                                                    |                               |
| record                             | Scroll top clicked         | cli/toc/scroll-top          |         | first heading in Table of contents clicked (Summary)                                                                           |                               |
| record                             | ToC panel options selected | cli/toc/scroll-to           | S:T     | RT heading clicked in Table of contents                                                                                        |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | toggle related table open  | cli/related/open            | S:T     | RT in RT section toggled open                                                                                                  |                               |
| record                             | toggle related table close | cli/related/close           | S:T     | RT in RT section toggled close                                                                                                 |                               |
| record                             | items per page dropdown    | cli/related/page-size       | S:T     | Dropdown was opened for related table. Selecting a page size will trigger a read request.                                      |                               |
| record                             | Table mode                 | cli/related/display/table   | S:T     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | cli/related/display/mkdn    | S:T     | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | cli/related/display/edit    | S:T     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | cli/related/delete/intend   | S:T RID | Delete was clicked from RT (edit/table mode) in RT section and confirm delete was shown                                        |                               |
| record                             | confirm delete cancelled   | cli/related/delete/cancel   | S:T RID | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | cli/related/unlink/intend   | S:T RID | Unlink was clicked from RT (edit/table mode) in RT section and confirm unlink (delete) was shown                               |                               |
| record                             | confirm unlink cancelled   | cli/related/unlink/cancel   | S:T RID | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | Table mode                 | cli/inline/display/table    | S:T     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | cli/inline/display/mkdn     | S:T     | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | cli/inline/display/edit     | S:T     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | cli/inline/delete/intend    | S:T RID | Delete was clicked from inline RT (edit/table mode) and confirm delete was shown                                               |                               |
| record                             | confirm delete cancelled   | cli/inline/delete/cancel    | S:T RID | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | cli/inline/unlink/intend    | S:T RID | Unlink was clicked from inline RT (edit/table mode) and confirm unlink (delete) was shown                                      |                               |
| record                             | confirm unlink cancelled   | cli/inline/unlink/cancel    | S:T RID | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | Add 1 record               | cli/create/clone            |         | User cloned 1 form                                                                                                             |                               |
| recordedit                         | Add x records              | cli/create/clone-x          |         | User cloned more than 1 form                                                                                                   |                               |
| recordedit                         | remove form                | cli/create/remove           |         | 1 form was removed from being created                                                                                          |                               |
| recordedit                         | open set all               | cli/create/set-all/open     | colname | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | cli/create/set-all/close    | colname | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | cli/create/set-all/cancel   | colname | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | cli/create/set-all/apply    | colname | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | cli/create/set-all/clear    | colname | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | remove form                | cli/update/remove           |         | 1 form was removed from being updated                                                                                          |                               |
| recordedit                         | open set all               | cli/update/set-all/open     | colname | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | cli/update/set-all/close    | colname | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | cli/update/set-all/cancel   | colname | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | cli/update/set-all/apply    | colname | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | cli/update/set-all/clear    | colname | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| navbar                             | branding link clicked      | cli/branding                | linkname| branding logo in the top left clicked                                                                                          |                               |
| navbar                             | user dropdown menu         | cli/dropdown/user           |         | user dropdown menu was opened (menu contains "Log Out" and "My Profile")                                                       |                               |
| navbar                             | My profile                 | cli/dropdown/user/profile   |         | My Profile button in top right dropdown to view profile details                                                                |                               |
| navbar                             | Navbar menu dropdown       | cli/dropdown/menu           | menuname| Navbar dropdown menu was opened (applies to top level and each nested sub menu)                                                |                               |
| navbar                             | Navbar menu internal link  | cli/dropdown/menu/static    | linkname| Navbar menu option was selected that redirects to static/internal resource (same domain)                                       |                               |
| navbar                             | Navbar menu external link  | cli/dropdown/menu/external  | linkname| Navbar menu option was selected that redirects to an external resource (different domain)                                      |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordset                          | facet panel open           | cli/panel/show              |         | "Show filter panel" button in recordset app clicked                                                                            |                               |
| recordset                          | facet panel close          | cli/panel/hide              |         | "Hide panel" button in recordset app clicked                                                                                   |                               |
| recordset                          | items per page dropdown    | cli/page-size               |         | Dropdown was opened. Selecting a page size will trigger a read request                                                         |                               |
| recordset                          | items per page dropdown    | cli/facet/page-size         |         | In facet "show more" popup, dropdown was opened. Selecting a page size will trigger a read request                             |                               |
| recordset                          | All on page                | cli/facet/all               |         | In facet "show more" popup, "All on page" button clicked                                                                       |                               |
| recordset                          | None on page               | cli/facet/none              |         | In facet "show more" popup, "None on page" button clicked                                                                      |                               |
| recordset                          | Reset selection            | cli/facet/reset             |         | In facet "show more" popup, "Reset selection" button clicked to remove selections                                              |                               |
| recordset                          | Modal closed               | cli/facet/cancel            |         | In facet "show more" popup, modal closed with no selection made                                                                |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | facet panel open           | cli/pb/panel/show           |         | In pure & binary "Add record" popup, "Show filter panel" button clicked                                                        |                               |
| record                             | facet panel close          | cli/pb/panel/hide           |         | In pure & binary "Add record" popup, "Hide panel" button clicked                                                               |                               |
| record                             | items per page dropdown    | cli/pb/page-size            |         | In pure & binary "Add record" popup, dropdown was opened. Selecting a page size will trigger a read request                    |                               |
| record                             | All on page                | cli/pb/all                  |         | In pure & binary "Add record" popup, "All on page" button clicked                                                              |                               |
| record                             | None on page               | cli/pb/none                 |         | In pure & binary "Add record" popup, "None on page" button clicked                                                             |                               |
| record                             | Reset selection            | cli/pb/reset                |         | In pure & binary "Add record" popup, "Reset selection" button clicked to remove selections                                     |                               |
| record                             | Modal closed               | cli/pb/cancel               |         | In pure & binary "Add record" popup, modal closed with no selection made                                                       |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | items per page dropdown    | cli/pb/facet/page-size      |         | In pure & binary "Add record" popup, then in facet "show more" popup, dropdown was opened                                      |                               |
| record                             | All on page                | cli/pb/facet/all            |         | In pure & binary "Add record" popup, then in facet "show more" popup, "All on page" button clicked                             |                               |
| record                             | None on page               | cli/pb/facet/none           |         | In pure & binary "Add record" popup, then in facet "show more" popup, "None on page" button clicked                            |                               |
| record                             | Reset selection            | cli/pb/facet/reset          |         | In pure & binary "Add record" popup, then in facet "show more" popup, "Reset selection" button clicked to remove selections    |                               |
| record                             | Modal closed               | cli/pb/facet/cancel         |         | In pure & binary "Add record" popup, then in facet "show more" popup, modal closed with no selection made                      |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | facet panel open           | cli/fk/panel/show           |         | In foreign key popup, "Show filter panel" button clicked                                                                       |                               |
| recordedit                         | facet panel closed         | cli/fk/panel/hide           |         | In foreign key popup, "Hide panel" button clicked                                                                              |                               |
| recordedit                         | items per page dropdown    | cli/fk/page-size            |         | In foreign key popup, dropdown was opened. Selecting a page size will trigger a read request                                   |                               |
| recordedit                         | Modal closed               | cli/fk/cancel               |         | In foreign key popup, modal closed with no selection made                                                                      |                               |              
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | items per page dropdown    | cli/fk/facet/page-size      |         | In foreign key popup, then in facet "show more" popup, dropdown was opened. Selecting a page size will trigger a read request  |                               |
| recordedit                         | All on page                | cli/fk/facet/all            |         | In foreign key popup, then in facet "show more" popup, "All on page" button clicked                                            |                               |
| recordedit                         | None on page               | cli/fk/facet/none           |         | In foreign key popup, then in facet "show more" popup, "None on page" button clicked                                           |                               |
| recordedit                         | Reset selection            | cli/fk/facet/reset          |         | In foreign key popup, then in facet "show more" popup, "Reset selection" button clicked to remove all selections               |                               |
| recordedit                         | Modal closed               | cli/fk/facet/cancel         |         | In foreign key popup, then in facet "show more" popup, modal closed with no selection made                                     |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
