...
| record                             | row delete clicked         | related/delete/intend       | schema_table rid | Delete was clicked from related table and confirm delete was shown (for both edit and not edit permission)                     |                               |
| record                             | confirm delete cancelled   | related/delete/cancel       | schema_table rid | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | related/unlink/intend       | schema_table rid | Unlink was clicked from related table and confirm unlink was shown (for both edit and not edit permission)                     |                               |
| record                             | confirm unlink cancelled   | related/unlink/cancel       | schema_table rid | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
...
| record                             | row delete clicked         | inline/delete/intend        | schema_table rid | Delete was clicked from inline related table and confirm delete was shown (for both edit and not edit permission)              |                               |
| record                             | confirm delete cancelled   | inline/delete/cancel        | schema_table rid | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | inline/unlink/intend        | schema_table rid | Unlink was clicked from inline related table and confirm unlink was shown (for both edit and not edit permission)              |                               |
| record                             | confirm unlink cancelled   | inline/unlink/cancel        | schema_table rid | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
...
| recordedit                         | close set all              | create/set-all/close        | column           | set all row closed (chevron up icon button)                                                                                    |                               |
...
| recordedit                         | close set all              | update/set-all/close        | column           | set all row closed (chevron up icon button)                                                                                    |                               |
