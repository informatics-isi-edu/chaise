...
| record                             | ToC panel open             | cli/toc/show                |         | Table of contents opened                                                                                                                               |                               |
| record                             | ToC panel collapse         | cli/toc/hide                |         | Table of contents closed                                                                                                                               |                               |
| record                             | ToC panel options selected | cli/toc/scroll-to           | S:T     |                                                                                                                                |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
...
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | Add 1 record               | cli/create/clone                |         |                                                                                                                                |                               |
| recordedit                         | Add x records              | cli/create/clone-x                |         |                                                                                                                                |                               |
| recordedit                         | remove form                | cli/create/remove               |         |                                                                                                                                |                               |
| recordedit                         | open set all               | cli/create/set-all/open              |    ? column-name     |                                                                                                                                |                               |
| recordedit                         | open set all               | cli/create/set-all/close              |    ?     |                                                                                                                                |                               |
| recordedit                         | cancel set all             | cli/create/set-all/cancel            |     ?    |                                                                                                                                |                               |
| recordedit                         | apply set all              | cli/create/set-all/apply             |     ?   |                                                                                                                                |                               |
| recordedit                         | clear all                  | cli/create/set-all/clear             |      ?    |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | remove form                | cli/update/remove               |         |                                                                                                                                |                               |
| recordedit                         | open set all               | cli/update/set-all/open              |      ?   |                                                                                                                                |                               |
| recordedit                         | open set all               | cli/update/set-all/close              |     ?    |                                                                                                                                |                               |
| recordedit                         | cancel set all             | cli/update/set-all/cancel            |     ?    |                                                                                                                                |                               |
| recordedit                         | apply set all              | cli/update/set-all/apply             |     ?    |                                                                                                                                |                               |
| recordedit                         | clear all                  | cli/update/set-all/clear             |     ?     |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| navbar                             | branding link clicked      | cli/branding                    |         | User clicked the branding logo in the top left and navigating to the static page                                               |                               |
| navbar                             | My profile                 | cli/profile                     |         | User clicked the My Profile button in top right dropdown to view profile details                                               |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset directive                | facet panel open           | cli/panel/show        |         |                                                                                                                                |                               |
| recordset directive                | facet panel collapse       | cli/panel/hide       |         |                                                                                                                                |                               |
| recordset                          | items per page dropdown    | cli/page-size         |         | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |
| recordset                          | items per page dropdown    | cli/facet/page-size         |         | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |
| recordset                          | All on page                | cli/facet/all         |         | All on page checkbox selected                                                                                                  |                               |
| recordset                          | None on page               | cli/facet/none        |         | None on page checkbox selected                                                                                                 |                               |
| recordset                          | Clear All                  | cli/facet/reset       |         | Clear all clicked to remove selection                                                                                          |                               |
| recordset                          | Modal closed               | cli/facet/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | items per page dropdown    | cli/related/page-size         |     ?    | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | facet panel open           | cli/pb/panel/show        |         |                                                                                                                                |                               |
| record                             | facet panel collapse       | cli/pb/panel/hide       |         |                                                                                                                                |                               |
| record                             | items per page dropdown    | cli/pb/page-size         |     ?    | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |
| record                             | All on page                | cli/pb/all         |         | All on page checkbox selected                                                                                                  |                               |
| record                             | None on page               | cli/pb/none        |         | None on page checkbox selected                                                                                                 |                               |
| record                             | Clear All                  | cli/pb/reset       |         | Clear all clicked to remove selection                                                                                          |                               |
| record                             | Modal closed               | cli/pb/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | items per page dropdown    | cli/pb/facet/page-size         |    ?     | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |            
| recordset                          | All on page                | cli/pb/facet/all         |         | All on page checkbox selected                                                                                                  |                               |
| recordset                          | None on page               | cli/pb/facet/none        |         | None on page checkbox selected                                                                                                 |                               |
| recordset                          | Clear All                  | cli/pb/facet/reset       |         | Clear all clicked to remove selection                                                                                          |                               |
| recordset                          | Modal closed               | cli/pb/facet/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |              
|                                    |                            |                             |         |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset directive                | facet panel open           | cli/fk/panel/show        |         |                                                                                                                                |                               |
| recordset directive                | facet panel collapse       | cli/fk/panel/hide       |         |                                                                                                                                |                               |
| recordedit                         | items per page dropdown    | cli/fk/page-size         |    ?     | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |     |
| recordset                          | Modal closed               | cli/fk/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |              
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | items per page dropdown    | cli/fk/facet/page-size         |    ?    | Dropdown was opened but not yet selected. Selecting a page size will trigger a read request with <action-name>                           |                               |
| recordset                          | All on page                | cli/fk/facet/all         |         | All on page checkbox selected                                                                                                  |                               |
| recordset                          | None on page               | cli/fk/facet/none        |         | None on page checkbox selected                                                                                                 |                               |
| recordset                          | Clear All                  | cli/fk/facet/reset       |         | Clear all clicked to remove selection                                                                                          |                               |
| recordset                          | Modal closed               | cli/fk/facet/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
