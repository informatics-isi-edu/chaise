...
| recordset                          | Clear selection            | facet/reset                 |                       | In facet "show more" popup, "Clear selection" button clicked to remove selections                                              |                               |
...
| record                             | Clear selection            | pb/reset                    |                       | In pure & binary "Add record" popup, "Clear selection" button clicked to remove selections                                     |                               |
...
| record                             | Clear selection            | pb/facet/reset              |                       | In pure & binary "Add record" popup, then in facet "show more" popup, "Clear selection" button clicked to remove selections    |                               |
...
| recordedit                         | Clear selection            | fk/facet/reset              |                       | In foreign key popup, then in facet "show more" popup, "Clear selection" button clicked to remove all selections               |                               |
