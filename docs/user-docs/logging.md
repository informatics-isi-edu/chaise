...
Each head request for the below client action events will be made to the same path in ermrest. This namespace will be "client_action", so each log request will be made to `.../ermrest/client_action`.

| App                                | Description (button name)  | Action                      | Extra   | Notes                                                                                                                          | Change                        |
|------------------------------------|----------------------------|-----------------------------|---------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| recordset                          | row delete clicked         | delete/intend               | RID     | Delete was clicked from table and confirm delete was shown. (use cid to determine app)                                         |                               |
| recordset                          | confirm delete cancelled   | delete/cancel               | RID     | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | delete clicked             | delete/intend               |         | Delete was clicked from submenu bar and confirm delete was shown. (use cid to determine app)                                   |                               |
| record                             | confirm delete cancelled   | delete/cancel               |         | User closed the confirm delete modal without deleting                                                                          |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordset/record                   | export dropdown            | export/open                 |         | Dropdown was opened. Selecting an export option will send a request, no need to capture that event (use cid to determine app)  |                               |
...
| record                             | copy live link             | share/live                  |         | Live link was copied to clipboard using glyphicon button                                                                       |                               |
| record                             | copy version link          | share/version               |         | Versioned link was copied to clipboard using glyphicon button                                                                  |                               |
...
| record                             | ToC panel options selected | toc/scroll-to               | S:T     | RT heading clicked in Table of contents                                                                                        |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | toggle related table open  | related/open                | S:T     | RT in RT section toggled open                                                                                                  |                               |
| record                             | toggle related table close | related/close               | S:T     | RT in RT section toggled close                                                                                                 |                               |
| record                             | items per page dropdown    | related/page-size           | S:T     | Dropdown was opened for related table. Selecting a page size will trigger a read request.                                      |                               |
| record                             | Table mode                 | related/display/table       | S:T     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | related/display/mkdn        | S:T     | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | related/display/edit        | S:T     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | related/delete/intend       | S:T RID | Delete was clicked from RT (edit/table mode) in RT section and confirm delete was shown                                        |                               |
| record                             | confirm delete cancelled   | related/delete/cancel       | S:T RID | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | related/unlink/intend       | S:T RID | Unlink was clicked from RT (edit/table mode) in RT section and confirm unlink (delete) was shown                               |                               |
| record                             | confirm unlink cancelled   | related/unlink/cancel       | S:T RID | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| record                             | items per page dropdown    | inline/page-size            | S:T     | Dropdown was opened for inline related table. Selecting a page size will trigger a read request.                               |                               |
| record                             | Table mode                 | inline/display/table        | S:T     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | inline/display/mkdn         | S:T     | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | inline/display/edit         | S:T     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | inline/delete/intend        | S:T RID | Delete was clicked from inline RT (edit/table mode) and confirm delete was shown                                               |                               |
| record                             | confirm delete cancelled   | inline/delete/cancel        | S:T RID | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | inline/unlink/intend        | S:T RID | Unlink was clicked from inline RT (edit/table mode) and confirm unlink (delete) was shown                                      |                               |
| record                             | confirm unlink cancelled   | inline/unlink/cancel        | S:T RID | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | Add 1 record               | create/clone                |         | User cloned 1 form                                                                                                             |                               |
| recordedit                         | Add x records              | create/clone-x              |         | User cloned more than 1 form                                                                                                   |                               |
| recordedit                         | remove form                | create/remove               |         | 1 form was removed from being created                                                                                          |                               |
| recordedit                         | open set all               | create/set-all/open         | colname | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | create/set-all/close        | colname | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | create/set-all/cancel       | colname | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | create/set-all/apply        | colname | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | create/set-all/clear        | colname | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | remove form                | update/remove               |         | 1 form was removed from being updated                                                                                          |                               |
| recordedit                         | open set all               | update/set-all/open         | colname | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | update/set-all/close        | colname | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | update/set-all/cancel       | colname | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | update/set-all/apply        | colname | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | update/set-all/clear        | colname | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| navbar                             | branding link clicked      | branding                    | linkname| branding logo in the top left clicked                                                                                          |                               |
| navbar                             | user dropdown menu         | dropdown/user               |         | user dropdown menu was opened (menu contains "Log Out" and "My Profile")                                                       |                               |
| navbar                             | My profile                 | dropdown/user/profile       |         | My Profile button in top right dropdown to view profile details                                                                |                               |
| navbar                             | Navbar menu dropdown       | dropdown/menu               | menuname| Navbar dropdown menu was opened (applies to top level and each nested sub menu)                                                |                               |
| navbar                             | Navbar menu internal link  | dropdown/menu/internal      | linkname| Navbar menu option was selected that redirects to static/internal resource (same domain)                                       |                               |
| navbar                             | Navbar menu external link  | dropdown/menu/external      | linkname| Navbar menu option was selected that redirects to an external resource (different domain)                                      |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
