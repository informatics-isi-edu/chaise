...
| record                             | hide empty related tables  | record/related/hide         |         | "Hide empty sections" clicked in submenu bar                                                                                   |                               |
| record                             | show empty related tables  | record/related/show         |         | "Show empty sections" clicked in submenu bar                                                                                   |                               |
...
| record                             | copy live link             | record/share/live           |         | Live link was copied to clipboard                                                                                              |                               |
| record                             | copy version link          | record/share/version        |         | Versioned link was copied to clipboard                                                                                         |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | Table mode                 | record/inline/display/table |         | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | record/inline/display/mkdn  |         | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | record/inline/display/edit  |         | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | Table mode                 | record/display/table        |         | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | record/display/mkdn         |         | User changed display format to show markdown display (edit and !edit/ permission)                                              |                               |
| record                             | Edit mode                  | record/display/edit         |         | User changed display format to show table display (user has permission to edit)                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | ToC panel open             | record/toc/panel/open       |         |                                                                                                                                |                               |
| record                             | ToC panel collapse         | record/toc/panel/close      |         |                                                                                                                                |                               |
| record                             | ToC panel options selected | record/toc/heading          |         |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset                          | export dropdown            | recordset/export            |         | Dropdown was opened. Selecting an export option will trigger a request so need to capture that event                           |                               |
| recordset                          | permalink                  | recordset/permalink/lclick  |         | User left clicked on permalink button (nothing actually happens, just logging the event)                                       |                               |
| recordset                          | permalink                  | recordset/permalink/rclick  |         | User right clicked on permalink button and opened the context menu                                                             |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordedit                         | Add 1 record               | create/add/1                |         |                                                                                                                                |                               |
| recordedit                         | Add x records              | create/add/x                |         |                                                                                                                                |                               |
| recordedit                         | remove form                | create/remove               |         |                                                                                                                                |                               |
| recordedit                         | remove form                | update/remove               |         |                                                                                                                                |                               |
| recordedit                         | open set all               | multi-edit/open             |         |                                                                                                                                |                               |
| recordedit                         | cancel set all             | multi-edit/cancel           |         |                                                                                                                                |                               |
| recordedit                         | apply set all              | multi-edit/apply            |         |                                                                                                                                |                               |
| recordedit                         | clear all                  | multi-edit/clear            |         |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| navbar                             | branding link clicked      | branding                    |         | User clicked the branding logo in the top left and navigating to the static page                                               |                               |
| navbar                             | My profile                 | profile                     |         | User clicked the My Profile button in top right dropdown to view profile details                                               |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset directive                | facet panel open           | recordset/facet/open        |         |                                                                                                                                |                               |
| recordset directive                | facet panel collapse       | recordset/facet/close       |         |                                                                                                                                |                               |
| recordset directive                | items per page dropdown    | recordset/page-size         |         | Dropdown was opened. Selecting a page size will trigger a read request so need to capture that event                           |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset multiselect directive    | All on page                | recordset/multi/all         |         | All on page checkbox selected                                                                                                  |                               |
| recordset multiselect directive    | None on page               | recordset/multi/none        |         | None on page checkbox selected                                                                                                 |                               |
| recordset multiselect directive    | Clear All                  | recordset/multi/clear       |         | Clear all clicked to remove selection                                                                                          |                               |
| recordset multiselect directive    | Modal closed               | recordset/select/cancel     |         | select (single/multi) modal was closed with no selection made                                                                  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| ellipsis directive (row)           | delete clicked             | row/delete/pending          |         | Delete was clicked and confirm delete was shown.                                                                               |                               |
| ellipsis directive (row)           | confirm delete cancelled   | row/delete/cancel           |         | Delete was clicked and confirm delete was shown. User then clicked cancel or X to close the modal without deleting             |                               |
| ellipsis directive (row)           | unlink clicked             | row/unlink/pending          |         | Unlink was clicked and confirm unlink (delete) was shown.                                                                      |                               |
| ellipsis directive (row)           | confirm unlink cancelled   | row/unlink/cancel           |         | Unlink was clicked and confirm unlink (delete) was shown. User then clicked cancel or X to close the modal without unlinking   |                               |
