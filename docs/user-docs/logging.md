...
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| navbar                             | branding link clicked      | cli/branding                |    ?    | branding logo in the top left clicked                                                                                          |                               |
...
| navbar                             | Navbar menu dropdown       | cli/dropdown/menu           |         | Navbar dropdown menu was opened (applies to top level and each nested sub menu)                                                |                               |
| navbar                             | Navbar menu internal link  | cli/dropdown/menu/static    |    ?    | Navbar menu option was selected that redirects to static/internal resource (same domain)                                       |                               |
| navbar                             | Navbar menu external link  | cli/dropdown/menu/external  |    ?    | Navbar menu option was selected that redirects to an external resource (different domain)                                      |                               |
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
