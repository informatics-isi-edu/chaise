...
|                   &ensp;           |                            |                             |         |                                                                                                                                |                               |
| recordset                          | export dropdown            | export                      |         | Dropdown was opened. Selecting an export option will send a request, no need to capture that event (use cid to determine app)  |                               |
...
| record                             | export dropdown            | export                      |         | Dropdown was opened. Selecting an export option will send a request, no need to capture that event (use cid to determine app)  |                               |
...
| navbar                             | Navbar menu internal link  | dropdown/menu/static        | linkname| Navbar menu option was selected that redirects to static/internal resource (same domain)                                       |                               |
