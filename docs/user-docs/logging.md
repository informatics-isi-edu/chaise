...
|------------------------------------|----------------------------|-----------------------------|------------------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| recordset                          | row delete clicked         | delete/intend               | uid              | Delete was clicked from table and confirm delete was shown. (use cid to determine app)                                         |                               |
| recordset                          | confirm delete cancelled   | delete/cancel               | uid              | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | delete clicked             | delete/intend               |                  | Delete was clicked from the main record page and confirm delete was shown. (use cid to determine app)                          |                               |
| record                             | confirm delete cancelled   | delete/cancel               |                  | User closed the confirm delete modal without deleting                                                                          |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
| recordset/record                   | export dropdown            | export/open                 |                  | Dropdown was opened. Selecting an export option will send a server request. (use cid to determine app)                         |                               |
...
| record                             | ToC panel options selected | toc/scroll-to               | schema_table     | Related table heading clicked in Table of contents                                                                             |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
| record                             | toggle related table open  | related/open                | schema_table     | Related table section toggled open                                                                                             |                               |
| record                             | toggle related table close | related/close               | schema_table     | Related table section toggled close                                                                                            |                               |
| record                             | items per page dropdown    | related/page-size           | schema_table     | Dropdown was opened for related table. Selecting a page size will trigger a read request.                                      |                               |
| record                             | Table mode                 | related/display/table       | schema_table     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | related/display/mkdn        | schema_table     | User changed display format to show markdown display (for both edit and not edit permission)                                   |                               |
| record                             | Edit mode                  | related/display/edit        | schema_table     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | related/delete/intend       | schema_table uid | Delete was clicked from related table and confirm delete was shown (for both edit and not edit permission)                     |                               |
| record                             | confirm delete cancelled   | related/delete/cancel       | schema_table uid | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | related/unlink/intend       | schema_table uid | Unlink was clicked from related table and confirm unlink was shown (for both edit and not edit permission)                     |                               |
| record                             | confirm unlink cancelled   | related/unlink/cancel       | schema_table uid | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
| record                             | items per page dropdown    | inline/page-size            | schema_table     | Dropdown was opened for inline related table. Selecting a page size will trigger a read request.                               |                               |
| record                             | Table mode                 | inline/display/table        | schema_table     | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | inline/display/mkdn         | schema_table     | User changed display format to show markdown display (for both edit and not edit permission)                                   |                               |
| record                             | Edit mode                  | inline/display/edit         | schema_table     | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | row delete clicked         | inline/delete/intend        | schema_table uid | Delete was clicked from inline related table and confirm delete was shown (for both edit and not edit permission)              |                               |
| record                             | confirm delete cancelled   | inline/delete/cancel        | schema_table uid | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | inline/unlink/intend        | schema_table uid | Unlink was clicked from inline related table and confirm unlink was shown (for both edit and not edit permission)              |                               |
| record                             | confirm unlink cancelled   | inline/unlink/cancel        | schema_table uid | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
...
| recordedit                         | open set all               | create/set-all/open         | column           | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | create/set-all/close        | column           | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | create/set-all/cancel       | column           | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | create/set-all/apply        | column           | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | create/set-all/clear        | column           | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
| recordedit                         | remove form                | update/remove               | uid              | 1 form was removed from being updated                                                                                          |                               |
| recordedit                         | open set all               | update/set-all/open         | column           | set all row opened (pencil icon button)                                                                                        |                               |
| recordedit                         | open set all               | update/set-all/close        | column           | set all row closed (chevron up icon button)                                                                                    |                               |
| recordedit                         | cancel set all             | update/set-all/cancel       | column           | set all row closed ("Cancel" button)                                                                                           |                               |
| recordedit                         | apply set all              | update/set-all/apply        | column           | set all row applied ("Apply All" button)                                                                                       |                               |
| recordedit                         | clear all                  | update/set-all/clear        | column           | set all row cleared ("Clear All" button)                                                                                       |                               |
|                   &ensp;           |                            |                             |                  |                                                                                                                                |                               |
| navbar                             | branding link clicked      | branding                    | name             | branding logo in the top left clicked                                                                                          |                               |
| navbar                             | user dropdown menu         | user                        |                  | user dropdown menu was opened (menu contains "Log Out" and "My Profile")                                                       |                               |
