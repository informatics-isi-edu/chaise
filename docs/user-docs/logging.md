...
|-----------------------------------------------------|-------------------------------------------------------|-----------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|
| chaise-wide (record, recordset, recordedit, viewer) | get catalog information                               | model/catalog                           |                              |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
|                                                     | get catalog schemas information                       | model/schema                            |                              |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
|                                                     |                                                       |                                         |                              |                                                                                                                                                       |                             |
| record                                              | load main entity                                      | record/main                             | ppid, pcid                   |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
|                                                     | load aggregates in main entity                        | record/aggregate                        | referrer                     |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
|                                                     | load inline entities                                  | record/inline                           | referrer                     |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
|                                                     | load aggregates in inline entities                    | record/inline/aggregate                 | referrer                     |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
|                                                     | load related entities                                 | record/related                          | referrer                     |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
|                                                     | load aggregates in related entities                   | record/related/aggregate                | referrer                     |                                                                                                                                                       | [bug fix (4/8/19)](#4/8/19) |
...
|                                                     | read existing values in association table             | pre-create/prefill/association/disabled | referrer                     | the request explained in previous row will return all the possible values to add. With this request, we know which rows should be disabled in the UI. | [bug fix (3/8/19)](#3/8/19) |
...
|                                                     | get default value for fks                             | default                                 |                              |                                                                                                                                                       | [changed (4/8/19)](#4/8/19) |
|                                                     |                                                       |                                         |                              |                                                                                                                                                       |                             |
...
| chaise-wide except viewer                           | recordset initialize preselected entity facets        | recordset/facet/init                    | referrer, source             | facet/filterstate are only reported inside the referrer                                                                                               | [added (4/8/19)](#4/8/19)   |
| chaise-wide except viewer                           | recordset get buckets for a facet                     | recordset/facet/histogram               | referrer, source, column     | facet/filter state are only reported inside the referrer                                                                                              | [added (4/8/19)](#4/8/19)   |
...
|                                                     |                                                       |                                         |                              |                                                                                                                                                       |                             |
| record                                              | export                                                | export                                  | template (displayname, type) |                                                                                                                                                       | [changed (4/8/19)](#4/8/19) |
|                                                     |                                                       |                                         |                              |                                                                                                                                                       |                             |
...
| record                                              | delete related entity rows                            | delete/record/related                   |                              |                                                                                                                                                       | [changed (4/8/19)](#4/8/19) |
|                                                     |                                                       |                                         |                              |                                                                                                                                                       |                             |
| viewer                                              | main request                                          | main                                    | ppid, pcid                   |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
|                                                     | get annotation table                                  | annotation                              |                              |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
|                                                     | get annotation comments                               | comment                                 |                              |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
|                                                     | get anatomy data                                      | anatomy                                 |                              |                                                                                                                                                       | [added (4/8/19)](#4/8/19)   |
