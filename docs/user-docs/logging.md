...
|------------------------------------|----------------------------|-----------------------------|---------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| recordset                          | row delete clicked         | cli/delete/intend           | ? row   | Delete was clicked from table and confirm delete was shown. (use cid to determine app)                                         |                               |
| recordset                          | confirm delete cancelled   | cli/delete/cancel           | ? row   | User closed the confirm delete modal without deleting                                                                          |                               |
...
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | row delete clicked         | cli/inline/delete/intend    | ? row   | Delete was clicked from inline RT (edit/table mode) and confirm delete was shown.                                              |                               |
| record                             | confirm delete cancelled   | cli/inline/delete/cancel    | ? row   | User closed the confirm delete modal without deleting                                                                          |                               |
| record                             | row unlink clicked         | cli/inline/unlink/intend    | ? row   | Unlink was clicked from inline RT (edit/table mode) and confirm unlink (delete) was shown.                                     |                               |
| record                             | confirm unlink cancelled   | cli/inline/unlink/cancel    | ? row   | User closed the confirm unlink modal without unlinking                                                                         |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | delete clicked             | cli/related/delete/intend   | ? row   | Delete was clicked and confirm delete was shown.                                                                              |                               |
| record                             | confirm delete cancelled   | cli/related/delete/cancel   | ? row   | Delete was clicked and confirm delete was shown. User then clicked cancel or X to close the modal without deleting            |                               |
| record                             | unlink clicked             | cli/related/unlink/intend   | ? row   | Unlink was clicked and confirm unlink (delete) was shown.                                                                     |                               |
| record                             | confirm unlink cancelled   | cli/related/unlink/cancel   | ? row   | Unlink was clicked and confirm unlink (delete) was shown. User then clicked cancel or X to close the modal without unlinking  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | hide empty sections        | cli/show-empty/hide         |         | "Hide empty sections" clicked in submenu bar                                                                                   |                               |
| record                             | show empty sections        | cli/show-empty/show         |         | "Show empty sections" clicked in submenu bar                                                                                   |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | export dropdown            | cli/export                  |         | Dropdown was opened. Selecting an export option will trigger a request so need to capture that event                           |                               |
| record                             | share popup                | cli/share                   |         | Share dialog was opened up.                                                                                                    |                               |
| record                             | copy live link             | cli/share/live              |         | Live link was copied to clipboard                                                                                              |                               |
| record                             | copy version link          | cli/share/version           |         | Versioned link was copied to clipboard                                                                                         |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | toggle related table open  | cli/related/open            |   ?      | "Show empty sections" clicked in submenu bar                                                                                   |                               |
| record                             | toggle related table close | cli/related/close           |   ?      | "Show empty sections" clicked in submenu bar                                                                                   |                               |
| record                             | Table mode                 | cli/inline/display/table    |       ?  | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | cli/inline/display/mkdn  |       ?  | User changed display format to show markdown display (edit and !edit permission)                                               |                               |
| record                             | Edit mode                  | cli/inline/display/edit  |      ?   | User changed display format to show table display (user has permission to edit)                                                |                               |
| record                             | Table mode                 | cli/related/display/table        |   ?      | User changed display format to show table display (user does not have permission to edit)                                      |                               |
| record                             | Custom mode                | cli/related/display/mkdn         |    ?     | User changed display format to show markdown display (edit and !edit/ permission)                                              |                               |
| record                             | Edit mode                  | cli/related/display/edit         |    ?     | User changed display format to show table display (user has permission to edit)                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| record                             | ToC panel open             | cli/toc/show       |         |                                                                                                                                |                               |
| record                             | ToC panel collapse         | cli/toc/hide      |         |                                                                                                                                |                               |
| record                             | ToC panel options selected | cli/toc/scroll-to          |    ?     |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset                          | export dropdown            | cli/export            |         | Dropdown was opened. Selecting an export option will trigger a request so need to capture that event                           |                               |
| recordset                          | permalink                  | cli/permalink/lclick  |         | User left clicked on permalink button (nothing actually happens, just logging the event)                                       |                               |
| recordset                          | permalink                  | cli/permalink/rclick  |         | User right clicked on permalink button and opened the context menu                                                             |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
