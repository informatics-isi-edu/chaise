...
| record                             | hide empty related tables  | record/hide-related         |         | "Hide empty related records" clicked in submenu bar                                                                            |                               |
| record                             | show empty related tables  | record/show-related         |         | "Show empty related records" clicked in submenu bar                                                                            |                               |
...
| recordset                          | permalink                  | recordset/permalink         |         |                                                                                                                                |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
...
|                                    |                            |                             |         |                                                                                                                                |                               |
| recordset directive                | facet panel open/collapse  | recordset/facet-panel       |         |                                                                                                                                |                               |
...
| recordset multiselect directive    | Records with values        | recordset/multi/not-null    |         | "records with values" checkbox selected                                                                                        |                               |
| recordset multiselect directive    | Records with no values     | recordset/multi/null        |         | "no value" checkbox selected                                                                                                   |                               |
| recordset multiselect directive    | Modal closed               | recordset/select/cancelled  |         | select (single/multi) modal was closed with no selection made                                                                  |                               |
|                                    |                            |                             |         |                                                                                                                                |                               |
| ellipses directive (row)           | delete clicked             | row/delete-pending          |         | Delete was clicked and confirm delete was shown.                                                                               |                               |
| ellipses directive (row)           | confirm delete cancelled   | row/delete-cancelled        |         | Delete was clicked and confirm delete was shown. User then clicked cancel or X to close the modal without deleting             |                               |
| ellipses directive (row)           | unlink clicked             | row/unlink-pending          |         | Unlink was clicked and confirm unlink (delete) was shown.                                                                      |                               |
| ellipses directive (row)           | confirm unlink cancelled   | row/unlink-cancelled        |         | Unlink was clicked and confirm unlink (delete) was shown. User then clicked cancel or X to close the modal without unlinking   |                               |
