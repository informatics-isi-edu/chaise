...
| ellipsis directive (row)           | confirm delete cancelled   | row/delete-cancelled        |         | Delete was clicked and confirm delete was shown. User then clicked cancel or X to close the modal without deleting             |                               |
| ellipsis directive (row)           | unlink clicked             | row/unlink-pending          |         | Unlink was clicked and confirm unlink (delete) was shown.                                                                      |                               |
| ellipsis directive (row)           | confirm unlink cancelled   | row/unlink-cancelled        |         | Unlink was clicked and confirm unlink (delete) was shown. User then clicked cancel or X to close the modal without unlinking   |                               |
