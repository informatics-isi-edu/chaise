...
| exportServicePath | String | "/iobox/export/" | "exportServicePath" : \<value\> | N/A | You can use this variable to switch between different export services that might be available in the deployment.
