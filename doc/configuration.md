...
| showDeleteButton | A boolean | true | "showDeleteButton":\<value\> | N/A | If not present or equal to **true**, the recordedit page will show delete button if editRecord is also true, and record page will show delete button if this is true. |
