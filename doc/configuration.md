...
| searchPageSize | An integer | 25 | "searchPageSize" : <value> | NA | If present, its value represents the number of records to be displayed on a page in the search view.
