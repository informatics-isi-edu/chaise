(function() {
    ...
    .controller('CommentsController', ['AuthService', 'CommentsService', '$rootScope', '$scope', '$uibModal', 'comments', function AnnotationsController(AuthService, CommentsService, $rootScope, $scope, $uibModal, comments) {
